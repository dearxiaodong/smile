...
public class IndexController extends AbstractController {
    ...
    public String index(HttpServletRequest request, HttpSession session) {
        ...
        UserVo users = (UserVo) session.getAttribute(WebConst.LOGIN_SESSION_KEY);

//       if (null==users ||StringUtils.isBlank(users.getEmail())){
//            //未登陆
//           return "admin/login";
//
//       }
        ...
        StatisticsBo staticticsBo = siteService.getStatistics();
        //取最新的15条日志
